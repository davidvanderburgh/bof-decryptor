<#
.SYNOPSIS
    Build script for the BOF Asset Decryptor Windows installer.
...
.DESCRIPTION
    ...
    installer. No third-party Python packages are required — the app uses only
...
$initFile = Join-Path $ProjectDir "bof_decryptor\__init__.py"
...
# Uncomment 'import site' to enable stdlib imports
...
# Patch ._pth for final install layout
$pthContent = @(
...
$issFile = Join-Path $ScriptDir "bof_decryptor.iss"
